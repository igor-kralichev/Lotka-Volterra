...
class DrawingComponent4 extends JPanel {
int yearsg[] =  Graph4.years;
int xg[] =  Graph4.x;
int yg[] =  Graph4.y;
int zg[] =  Graph4.z;
int xvg2[] =  Graph4.vx4;
...
public class Graph4 extends JFrame{
     ...
     public  static int y[];
     public  static int z[];
     public  static int vx4[]; 
     public  static int vy4[]; 
     public  static int vz4[];
     public static int n = 12;

    
 public Graph4 () {  
        super("График статической системы логарифмического метода");
        JPanel jcp = new JPanel(new BorderLayout());
        setContentPane(jcp);
        jcp.add(new DrawingComponent4 (), BorderLayout.CENTER);     
